        ...
        for i in range(int(msg[0])):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await event.client.send_file(event.chat_id, "https://t.me/Source_NiNJA/4", caption=f'''
> 𝙷𝙸 𝙽𝙸𝙽𝙹𝙰 𝙸 𝙶𝙾𝚃 𝚄𝚂𝙴𝚁 🥷
...
=========================
⤷ 𝚂𝙾𝚄𝚁𝙲𝙴 : @q47777 ''')
                    await event.client.send_file("@RQBBBB", "https://t.me/Source_NiNJA/4", caption=f'''
> 𝙷𝙸 𝙽𝙸𝙽𝙹𝙰 𝙸 𝙶𝙾𝚃 𝚄𝚂𝙴𝚁 🥷
...
⤷ 𝚂𝙾𝚄𝚁𝙲𝙴 : @q47777''') 
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "Selling IDs : @q47777 ")
            ...
            for i in range(int(msg[0])):
                ...
                if "Available" in isav:
                    try:
                        await sython(functions.channels.UpdateUsernameRequest(
                            channel=ch, username=username))
                        await event.client.send_message("@RQBBBB", f'''𝙷𝙸 𝚂𝙸𝚁 , 𝚆𝙷𝙰𝚃'𝚂 𝚄𝙿 𝙼𝙰𝙽 . 
𝚄𝚂𝙴𝚁 𝙸𝚂 𝙷𝚄𝙽𝚃𝙴𝙳 『 @{username} 』
𝙰𝚃𝚃𝙴𝙼𝙿𝚃𝚂 『 {trys} 』
𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙴 𝚃𝙷𝙴 𝚂𝙰𝚅𝙴 『 channel 』
𝙱𝚈 𝚂𝙿𝙸𝙳𝙴𝚁 『 @Xx_617''')
                        break
                    except telethon.errors.rpcerrorlist.UsernameInvalidError:
    ...
    {str(eee)}''')
        ...
        if msg[0] == "يدوي":  # تثبيت يدوي يوزر قناة
            ...
            try:
                await sython(functions.channels.UpdateUsernameRequest(
                    channel=ch, username=username))
                await event.client.send_message(event.chat_id, f'''𝙷𝙸 𝚂𝙸𝚁 , 𝚆𝙷𝙰𝚃'𝚂 𝚄𝙿 𝙼𝙰𝙽 . 
𝚄𝚂𝙴𝚁 𝙸𝚂 𝙷𝚄𝙽𝚃𝙴𝙳 『 @{username} 』
𝙰𝚃𝚃𝙴𝙼𝙿𝚃𝚂 『 {trys} 』
𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙴 𝚃𝙷𝙴 𝚂𝙰𝚅𝙴 『 channel 』
𝙱𝚈 𝚂𝙿𝙸𝙳𝙴𝚁 『 @Xx_617''')
